            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mt-4">
                <div className="flex">
                    ...
                    <div className="flex flex-col">
                        <input className="mr-4 p-2" type="text" placeholder="Назва фільму" {...register('filmName', { validate: () => {
                    ...
                    <div className="flex flex-col">
                         <input type="date" placeholder="Дата початку по типу" {...register('date', { validate: () => {
                        return  filmName || date ? true : 'Вкажіть хоча б назву фільму або дату'
                        }})} />
                        {errors.date && <span className='p-2 text-red-500'>{errors.date.message}</span>}
                    </div>
                ...
                <button className="cursor-pointer bg-red-500 p-3 text-white rounded-2xl hover:bg-red-600 transition mt-2 " type='submit'>Пошук</button>
            </form>
